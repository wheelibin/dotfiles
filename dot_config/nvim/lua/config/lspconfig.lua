...
legendary.bind_keymaps({
  -- { "[d",  '<cmd>lua vim.diagnostic.goto_prev()<CR>', description = "Prev Diagnostics Item", buffer = 0, mode = "t" }
...
local on_attach = function(client, bufnr)
  ...
  legendary.bind_keymaps({
    ...
    { "<leader>f", helpers.lazy(vim.lsp.buf.format, { async = true }), description = "Format buffer (LSP)", buffer = bufnr }
  })
