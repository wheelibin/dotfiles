...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/20/x55jc4v91hl21t907n_vttth83mmp5/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/khck244/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/khck244/.mailcheckrc"
# }
